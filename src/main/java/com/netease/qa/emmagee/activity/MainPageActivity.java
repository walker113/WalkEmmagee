...
import com.netease.qa.emmagee.service.MonitorService;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				Programe app = processInfo.getRunningProcessSelf(MainPageActivity.this);
				if (app == null) return;
				String packageName = app.getPackageName();
				String processName = app.getProcessName();
				KLog.e("\npid = " + pid + "\nprocessName = " + processName + "\npackageName = " + packageName);
				waitForAppStart(packageName);
				Intent mIntent = new Intent(MainPageActivity.this, MonitorService.class);
				mIntent.putExtra("processName", processName);
